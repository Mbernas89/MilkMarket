        ...
        <div class="taskbar-inner">
            ...
            <details class="taskbar-menu">
                <summary class="taskbar-trigger account-trigger" aria-label="Open account menu">
                    ...
                    <?php else: ?>
                        <span id="global-nav-unread-dot" class="account-alert-dot" aria-label="Unread activity"
                ...
                <div class="search-users-list">
                    <?php foreach ($users as $user): ?>
                        <article class="search-user-row">
                            <div class="post-identity profile-preview-trigger" data-user-id="<?php echo (int) $user["id"]; ?>"
                                style="cursor:pointer;">
                                <?php if (!empty($user["profile_image"])): ?>
                                    <img class="avatar-circle small-avatar avatar-image"
                                        src="<?php echo htmlspecialchars($user["profile_image"]); ?>"
                                        alt="<?php echo htmlspecialchars($user["username"]); ?> profile picture">
                                <?php else: ?>
                                    <div class="avatar-circle small-avatar">
                            ...
                            <div class="search-user-actions">
                                ...
                                <?php endif; ?>
                                <a class="message-seller-button"
                                    href="messages.php?recipient_id=<?php echo (int) $user["id"]; ?>">Message</a>
                            </div>
                        </article>
                    <?php endforeach; ?>
                </div>
